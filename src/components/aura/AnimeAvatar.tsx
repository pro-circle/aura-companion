    ...
    >
      ...
      <g ref={stage}>
        ...
        <g ref={head}>
          ...
          <g ref={bangs}>
            <path
              d="M112 208 C104 128 140 72 200 72 C260 72 296 128 288 208
                 C282 176 272 156 260 146 C254 178 244 196 232 208
                 C234 170 224 140 206 122 C198 152 182 182 162 200
                 C156 176 148 158 138 150 C128 166 118 186 112 208 Z"
              fill="url(#hairGrad)"
            />
